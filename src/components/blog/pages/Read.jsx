  ...
  return (
    <>
      <div className='blog-container'>
        <div className='blog-container-form'>
          <div className='blog-container1'>
            ...
            <div className='blog-content1'>
                    ...
                    <div className='blog-img0'>
                      <img src='/image/div0.jpg' alt='img'/>
                    </div>
                    <div className='blog-paragarph'>
<p>When it comes to designing the interiors of your home, the goal is not just to make
   it aesthetically pleasing but also to create a space that feels like a <br/>sanctuary. 
  Your living space should be a cozy retreat where you can unwind, relax, and truly feel at home.
  In this blog post, we’ll explore some key tips  <br/>for designing a comfortable living space that balances style and functionality.</p>
                    </div>
                    <div className='blog-paragarph1'>
                      <p>1. Choose Warm and Inviting Colors:</p>
                      </div>
                      <div className='blog-paragarph2'>
          ...
          <div className='blog-gap'> </div>
          <div className='blog-container10'>
          <div className='blog-content'>
                        <span>Leave a Comment</span>
                    </div>
                    <div className='blog-paragarph'>Your email address will not be published. Required fields are marked *</div>
